...
class NewsController extends Controller
{
    ...
    {
        try {
            return view('OliveMediaNewsPackage::news.create');
        } catch (\Exception $ex) {
            return $ex->getMessage();
        }
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view("OliveMediaNewsPackage::news.view", ['news' => $news]);
        } catch (\Exception $ex) {
            return $ex->getMessage();
        }
    }
    ...
    public function edit($id)
    {
        try {
            ...
            return view("OliveMediaNewsPackage::news.edit", ['news' => $news]);
        } catch (\Exception $ex) {
            return $ex->getMessage();
        }
